...
const User = memo(() => {
  ...
  const handleLogout = () => {
    ...
    // console.log("im inside the handleLogout");
  };
        ...
        <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
          <ul class="space-y-2 font-medium">
            <li>
              <Link
                to={"/user-dashboard"}
                class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-300 font-bold dark:hover:bg-gray-700 group"
              >
                ...
                <span class="ms-3 font-bold  ml-2 hover:font-bold">
                  {`Hello ` + userName}
                </span>
              </Link>
            </li>
            <li>
              <Link
                to={"/issueBook"}
                class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-300  dark:hover:bg-gray-700 group hover:font-bold"
              >
            ...
            <li>
              <Link
                to={"/"}
                ref={linkRef}
                class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-300 dark:hover:bg-gray-700 group mt-[63vh] hover:font-bold"
...
//   return prevProps.navigate === nextProps.navigate;
// });
